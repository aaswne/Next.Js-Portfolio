export const projects = [
    {
        ...
        tech: ["Next.js", "Tailwind CSS", "Gemini Ai" , "JavaScript" , ],
        features: [
...

    {
        ...
        image: "/image/olx.webp",
        overview:
            "A full-stack marketplace platform modeled after OLX, allowing users to list, browse, and purchase products. Features include real-time updates, authentication, and smooth user experience.",
        tech: ["Next.js", "Firebase", "Firestore", "JavaScript"] ,
        features: [
        ...
        challenges:
            "Handling real-time data updates and ensuring smooth UX.",
